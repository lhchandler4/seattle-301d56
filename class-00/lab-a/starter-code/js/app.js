...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT. If we change the let back to var on line 33 then the code works again. This is because var is function scoped and let is block scoped
  console.log(viewed);
